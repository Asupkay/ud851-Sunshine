...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherDate(){
        new forecastNetworkRequests().execute(SunshinePreferences.getPreferredWeatherLocation(this));
    }

    private class forecastNetworkRequests extends AsyncTask<String, Void, String[]>{
        @Override
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                String[] response = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, JSONWeatherData);
                return response;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
