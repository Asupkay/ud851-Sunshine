...
//  COMPLETED (8) Provide an implementation for the query method
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            case CODE_WEATHER:
                mCursor = mOpenHelper.getReadableDatabase().query(WeatherContract.WeatherEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
            ...
            case CODE_WEATHER_WITH_DATE:
                ...
                mCursor = getContext().getContentResolver().query(uri, projection, WeatherContract.WeatherEntry.COLUMN_DATE + " = ? ", selectionArguments, sortOrder);
                break;
            default:
