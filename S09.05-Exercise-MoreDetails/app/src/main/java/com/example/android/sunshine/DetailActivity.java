...
//      COMPLETED (13) Find each of the TextViews by ID
        tDate = (TextView) findViewById(R.id.day_date);
        tDescription = (TextView) findViewById(R.id.day_description);
        tHigh = (TextView) findViewById(R.id.day_high_temp);
        tLow = (TextView) findViewById(R.id.day_low_temp);
        tHumidity = (TextView) findViewById(R.id.day_humidity);
        tWind = (TextView) findViewById(R.id.day_wind);
        tPressure = (TextView) findViewById(R.id.day_pressure);
...
//          COMPLETED (23) If the loader requested is our detail loader, return the appropriate CursorLoader
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        tHigh.setText(highString);

        double lowInCelsius = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString = SunshineWeatherUtils.formatTemperature(this, lowInCelsius);
        tLow.setText(lowString);

        float humidity = data.getFloat(INDEX_WEATHER_HUMIDITY);
        String humidityString = getString(R.string.format_humidity, humidity);
        tHumidity.setText(humidityString);

        float windSpeed = data.getFloat(INDEX_WEATHER_WIND_SPEED);
        float windDirection = data.getFloat(INDEX_WEATHER_DEGREES);
        String windString = SunshineWeatherUtils.getFormattedWind(this, windSpeed, windDirection);
        tWind.setText(windString);

        float pressure = data.getFloat(INDEX_WEATHER_PRESSURE);
        String pressureString = getString(R.string.format_pressure, pressure);
        tPressure.setText(pressureString);
